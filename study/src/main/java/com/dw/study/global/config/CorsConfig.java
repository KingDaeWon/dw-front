...
/*
    ...
    Cors설정이 안 되어있으면 오류가 발생한다. 이를 방지하기 위해 Cors 설정을 해주어야 함.
 */
@Configuration
...
/*
    Credentials: 처리방식을 설정해 준다. 기본적으로 요청에 대한 응답으로 json타입이 나간다.
        이를 Javascript에서 처리할 수 있게 해 준다. 이를 통해 프런트엔드에서 처리된 응답을 뷰에 맞게 설정해 줄 수 있다.
